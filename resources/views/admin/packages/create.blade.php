                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title"
                                           value="{{ old('title', $package->title) }}" placeholder="Enter Title">
                                    @error('title')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="duration"
                                           value="{{ old('duration', $package->duration) }}" placeholder="Enter duration (e.g., 1 month)">
                                    @error('duration')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="features" rows="4"
                                              placeholder="Enter package features">{{ old('features', $package->features) }}</textarea>
                                    @error('features')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
